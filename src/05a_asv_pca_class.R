### CLASS
dim(asv_class_grouped_wk10_wide)
#View(asv_class_grouped_wk10_wide)

###ind pca of treatments
esf_asv_pca_treatment_wk2 <- prcomp(t(asv_class_grouped_wk2_wide), scale = TRUE)
...
fviz_treatment_wk2 <-  fviz_pca_ind(esf_asv_pca_treatment_wk2,
  ...
  labs(title ="Treatment PCA Week 2 (Class)", x = "", y = "PC2")
fviz_treatment_wk2

esf_asv_pca_treatment_wk6 <- prcomp(t(asv_class_grouped_wk6_wide), scale = TRUE)
#graph of samples ## too many overlaps
...
esf_asv_pca_treatment_wk10 <- prcomp(t(asv_class_grouped_wk10_wide), scale = TRUE)
#graph of samples ## too many overlaps
...
###ind pca of asvs
esf_asv_pca_wk2 <- prcomp(asv_class_grouped_wk2_wide, scale = TRUE)
#graph of samples ## too many overlaps
...
fviz_asv_wk2 <-  fviz_pca_ind(esf_asv_pca_wk2,
                                    ...
                                    gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),
                                    repel = TRUE) +     # Avoid text overlapping
  labs(title ="ASV PCA Week 2 (Class)", x = "", y = "")
fviz_asv_wk2

esf_asv_pca_wk6 <- prcomp(asv_class_grouped_wk6_wide, scale = TRUE)
#graph of samples ## too many overlaps
...
esf_asv_pca_wk10 <- prcomp(asv_class_grouped_wk10_wide, scale = TRUE)
#graph of samples ## too many overlaps
